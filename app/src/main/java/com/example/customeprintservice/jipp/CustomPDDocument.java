...
public class CustomPDDocument implements Closeable {
...
//    }
    ...
    private CustomPDDocumentCatalog documentCatalog;
     ...
     */
    public CustomPDDocument(MemoryUsageSetting memUsageSetting)
    {
     ...
     */
    public CustomPDDocument(COSDocument doc)
    {
        this(doc, null);
    }
     ...
     */
    public CustomPDDocument(COSDocument doc, RandomAccessRead source)
    {
     ...
     *
     */
    public CustomPDDocument(COSDocument doc, RandomAccessRead source, AccessPermission permission)
    {
        document = doc;
        pdfSource = source;
...
//    }
     ...
     */
    public CustomPDDocumentCatalog getDocumentCatalog()
    {
        if (documentCatalog == null)
        {
            ...
            {
                documentCatalog = new CustomPDDocumentCatalog(this, (COSDictionary) dictionary);
            }
            else
            {
                documentCatalog = new CustomPDDocumentCatalog(this);
            }
        }
...
//    }
     ...
     */
    public static CustomPDDocument load(InputStream input) throws InvalidPasswordException, IOException
    {
     ...
     * @throws IOException In case of a reading or parsing error.
     */
    public static CustomPDDocument load(InputStream input, MemoryUsageSetting memUsageSetting)
            throws InvalidPasswordException, IOException
    {
     ...
     * @throws IOException In case of a reading or parsing error.
     */
    public static CustomPDDocument load(InputStream input, String password)
            throws InvalidPasswordException, IOException
    {
     ...
     * @throws IOException In case of a reading or parsing error.
     */
    public static CustomPDDocument load(InputStream input, String password, InputStream keyStore, String alias)
            throws IOException
    {
     ...
     * @throws IOException In case of a reading or parsing error.
     */
    public static CustomPDDocument load(InputStream input, String password, MemoryUsageSetting memUsageSetting)
            throws InvalidPasswordException, IOException
    {
     ...
     * @throws IOException In case of a reading or parsing error.
     */
    public static CustomPDDocument load(InputStream input, String password, InputStream keyStore,
                                  String alias, MemoryUsageSetting memUsageSetting) throws IOException
    {
        ...
        try
        {
            ...
            CustomPDFParser parser = new CustomPDFParser(source, password, keyStore, alias, scratchFile);
            parser.parse();
            return parser.getCustomPDDocument();
        }
        catch (IOException ioe)
        {
            IOUtils.closeQuietly(scratchFile);
...
//    }
     ...
     */
    public CustomPDPage getPage(int pageIndex) // todo: REPLACE most calls to this method with BELOW method
    {
